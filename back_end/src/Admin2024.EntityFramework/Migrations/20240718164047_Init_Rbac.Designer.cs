<<<<<<<< HEAD:back_end/src/Admin2024.EntityFramework/Migrations/20240718140323_First.Designer.cs
﻿// <auto-generated />
using System;
...
namespace Admin2024.EntityFramework.Migrations
{
    ...
    [Migration("20240718140323_First")]
    partial class First
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Admin2024.Domain.System.Operation", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 575, DateTimeKind.Utc).AddTicks(9164))
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 575, DateTimeKind.Utc).AddTicks(9407))
            ...
            modelBuilder.Entity("Admin2024.Domain.System.Permission", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 576, DateTimeKind.Utc).AddTicks(2691))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 576, DateTimeKind.Utc).AddTicks(3033))
                        .HasColumnName("update_at");
            ...
            modelBuilder.Entity("Admin2024.Domain.System.Resource", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 576, DateTimeKind.Utc).AddTicks(6065))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 576, DateTimeKind.Utc).AddTicks(6271))
                        .HasColumnName("update_at");
            ...
            modelBuilder.Entity("Admin2024.Domain.System.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 576, DateTimeKind.Utc).AddTicks(8925))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 576, DateTimeKind.Utc).AddTicks(9161))
                        .HasColumnName("update_at");
            ...
            modelBuilder.Entity("Admin2024.Domain.System.RolePermission", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(1625))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(1831))
                        .HasColumnName("update_at");
            ...
            modelBuilder.Entity("Admin2024.Domain.System.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(4422))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(4631))
                        .HasColumnName("update_at");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d6565d53-7f83-4b23-a00e-dec22478aa57"),
                            CreateAt = new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(8190),
                            CreateBy = new Guid("d6565d53-7f83-4b23-a00e-dec22478aa57"),
                            ...
                            UpdateAt = new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(8191),
                            UpdateBy = new Guid("d6565d53-7f83-4b23-a00e-dec22478aa57"),
                            Username = "Boss"
                        });
                });
            ...
            modelBuilder.Entity("Admin2024.Domain.System.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(7319))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 7, 18, 14, 3, 22, 577, DateTimeKind.Utc).AddTicks(7599))
                        .HasColumnName("update_at");
...
{
    [DbContext(typeof(AdminDbContext))]
    [Migration("20240718164047_Init_Rbac")]
...
>>>>>>>> cd2dff46a4fc0a3f99d221fe23302866333e5894:back_end/src/Admin2024.EntityFramework/Migrations/20240718164047_Init_Rbac.Designer.cs
